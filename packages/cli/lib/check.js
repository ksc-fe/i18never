...
module.exports = (options) => {
    ...
    if (!rootDir && !tokenOption) {
        console.error(
            'Missing permission information. Please configure the. i18neverrc.js file in the root directory or use the i18never command to explicitly configure the - t parameter'
        );
        process.exit(1);
    }
