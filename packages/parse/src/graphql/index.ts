...
export type QueryOrCreateDictsQuery = {
    __typename?: 'Query';
    dicts: Array<{
        __typename?: 'Dict';
        key: string;
...
export function getSdk(
    ...
    return {
        QueryOrCreateDicts(
            variables: QueryOrCreateDictsQueryVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<QueryOrCreateDictsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<QueryOrCreateDictsQuery>(
                        QueryOrCreateDictsDocument,
                        variables,
